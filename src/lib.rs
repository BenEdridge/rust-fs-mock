//! BASED ON: https://github.com/rust-lang/rust/commit/d0178b4f99c70d2443f9b76421429d0d23dadc45
...
pub use std::io::{BufRead, Read, Seek, Write, SeekFrom};
...
// impl AsInner<File> for File {
//     fn as_inner(&self) -> &File {
//         &self.inner
//     }
// }
// impl FromInner<File> for File {
//     fn from_inner(f: File) -> File {
//         File { inner: f }
//     }
// }
// impl IntoInner<File> for File {
...
impl OpenOptions {
    ...
    fn _open(&self, path: &Path) -> io::Result<File> {
        // File::open(path, &self.0).map(|inner| File { inner })
        todo!()
    }
}

// impl AsInner<fs_imp::OpenOptions> for OpenOptions {
//     fn as_inner(&self) -> &OpenOptions {
//         &self.0
//     }
// }

// impl AsInnerMut<OpenOptions> for OpenOptions {
//     fn as_inner_mut(&mut self) -> &mut OpenOptions {
//         &mut self.0
//     }
// }
...
pub fn soft_link<P: AsRef<Path>, Q: AsRef<Path>>(src: P, dst: Q) -> io::Result<()> {
    ...
    todo!("rustc_deprecated(since = \"1.1.0\",reason = replaced with std::os::unix::fs::symlink and std::os::windows::fs::{{symlink_file, symlink_dir}}");
}
...
impl DirBuilder {
    ...
    pub fn new() -> DirBuilder {
        // DirBuilder { inner: DirBuilder::create(&self, path), recursive: false }
        todo!()
    }
